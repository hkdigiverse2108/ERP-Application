...
class AppColors {
  ...
  static const Color lightSectionPaid = Color(0xffFFE4F7);
  static const Color lightSectionProfit = Color(0xffFFE4F6);
  ...
  static const Color darkSectionSell = Color(0xFF558DF7);
  static const Color darkSectionSellPurchase = Color(0xFF8AD0FB);
  static const Color darkSectionPaid = Color(0xFFF98BD8);
  static const Color darkSectionProfit = Color(0xFFFD9AD4);
