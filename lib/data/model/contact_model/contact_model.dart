...
class ContactListModel {
    ...
    return ContactListModel(
      contactData: json["contact_data"] == null
          ...
          : List<ContactModel>.from(
              json["contact_data"].map((x) => ContactModel.fromJson(x)),
            ),
  ...
  Map<String, dynamic> toJson() => {
        "contact_data": List<dynamic>.from(contactData.map((x) => x.toJson())),
        "totalData": totalData,
        "state": state?.toJson(),
      };
}
...
class ContactModel {
  ...
  factory ContactModel.fromJson(Map<String, dynamic> json) => ContactModel(
        ...
        phoneNo:
            json["phoneNo"] == null ? null : PhoneNo.fromJson(json["phoneNo"]),
...
class Address {
  ...
  factory Address.fromJson(Map<String, dynamic> json) => Address(
        ...
        country:
            json["country"] == null ? null : Location.fromJson(json["country"]),
