...
class OrderListTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Obx(() {
        if (controller.isLoading.value && controller.posOrders.isEmpty) {
          return const TableShimmer();
        }
        ThemeService().isDarkMode;

        final items = controller.posOrders;
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Gap(16),
                    TextButton.icon(
                      onPressed: () => controller.fetchPosOrders(),
        ...
        return BorderContainer(
          child: Column(
            children: [
              ...
              CommonTable<OredrListModel>(
                isLoading: controller.isLoading.value,
                items: controller.posOrders.toList(),
                columns: [
                  TableColumn(
                    title: 'Invoice No',
                    width: 140,
