...
import 'package:ai_setu/modules/sales/estimate/widgets/estimate_item_card.dart';
import 'package:ai_setu/modules/sales/estimate/widgets/estimate_summary_section.dart';
...
class EstimateAddEditView extends GetView<EstimateAddEditController> {
  const EstimateAddEditView({super.key});
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  const Gap(Sizes.paddingS),
                  _buildEstimateInfoSection(context),
                  ...
                  const Gap(Sizes.paddingM),
                  EstimateSummarySection(controller: controller),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Create professional estimates for your customers",
  ...
  Widget _buildEstimateInfoSection(BuildContext context) {
    return EditSection(
          ...
          Row(
            children: [
                  ...
                  child: IgnorePointer(
                    child: EditTextField(
                      ...
                      controller: TextEditingController(
                        text: DateFormat(
                          'dd/MM/yyyy',
                        ).format(controller.estimateDate.value),
                      ),
              ...
              Expanded(
                child: EditTextField(
                  label: "Estimate No",
                  controller: controller.estimateNoController,
  ...
  Widget _buildAdditionalChargeCard(
    ...
    int index,
    EstimateAdditionalChargeState charge,
  ) {
    return Container(
