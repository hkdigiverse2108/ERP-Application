...
class SalesOrderController extends GetxController {
  static SalesOrderController get instance => Get.find();
  ...
  // Caching
  final _cache =
      <String, ({List<SalesOrderModel> items, DateTime fetchedAt})>{};
  ...
  Future<void> getSalesOrdersData() async {
    ...
    try {
      ...
      salesOrders.value = pagination.items;
