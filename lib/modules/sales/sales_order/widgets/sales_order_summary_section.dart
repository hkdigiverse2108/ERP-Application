...
class SalesOrderSummarySection extends StatelessWidget {
  final SalesOrderAddEditController controller;

  const SalesOrderSummarySection({super.key, required this.controller});
    ...
    return EditSection(
      ...
      child: Column(
        children: [
          ...
          _buildRow(context, "Item Discount", controller.totalDiscount, isNegative: true),
          ...
          _buildRow(context, "Total Tax", controller.totalTaxAmount),
          const Gap(Sizes.paddingM),
          Container(
  ...
  Widget _buildRow(BuildContext context, String label, RxDouble value, {bool isNegative = false}) {
    return Padding(
          ...
          Obx(
            () => Text(
              ...
              style: TextHelper.bodyLargeStyle(context).copyWith(
                ...
                color: isNegative ? context.appColors.error : context.appColors.textPrimary,
              ),
            ),
          ),
        ],
