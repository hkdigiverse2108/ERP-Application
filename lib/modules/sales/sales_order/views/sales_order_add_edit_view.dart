...
import 'package:ai_setu/modules/sales/sales_order/controllers/sales_order_add_edit_controller.dart';
import 'package:ai_setu/modules/sales/sales_order/widgets/sales_order_item_card.dart';
import 'package:ai_setu/modules/sales/sales_order/widgets/sales_order_summary_section.dart';
...
class SalesOrderAddEditView extends GetView<SalesOrderAddEditController> {
  const SalesOrderAddEditView({super.key});
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  const Gap(Sizes.paddingS),
                  _buildSalesOrderInfoSection(context),
                  ...
                  const Gap(Sizes.paddingM),
                  SalesOrderSummarySection(controller: controller),
  ...
  Widget _buildSalesOrderInfoSection(BuildContext context) {
    return EditSection(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: InkWell(
                  onTap: () => _selectDate(context, controller.salesOrderDate),
                  child: IgnorePointer(
                    child: EditTextField(
                      label: "Date",
              ...
              Expanded(
                child: EditTextField(
                  label: "Order No",
                  controller: controller.salesOrderNoController,
