...
class DebitAddEditView extends GetView<DebitAddEditController> {
  const DebitAddEditView({super.key});
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  "${controller.isEdit ? 'Edit' : 'Add'} Debit Note",
                ...
                Text(
                  "Record debit notes for accounting",
      ...
      child: Center(
        child: Obx(
          () => EditImagePicker(
            ...
            label: "Tap to select debit note image",
          ),
        ),
      ),
    );
