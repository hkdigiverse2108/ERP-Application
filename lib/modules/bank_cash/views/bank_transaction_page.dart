...
import 'package:ai_setu/modules/bank_cash/widgets/bank_transaction_table.dart';
...
class _BankTransactionPageState extends State<BankTransactionPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Get.find<BankCashController>().fetchBankCashTransaction();
    });
  }
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            QuickAction(),
            _buildSectionTitle('Bank Transaction'),
