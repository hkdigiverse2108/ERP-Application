...
class PrefixAddEditView extends GetView<PrefixAddEditController> {
  const PrefixAddEditView({super.key});
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  controller.isEdit ? "Edit Prefix" : "Add Prefix",
      ...
      child: Column(
        children: [
          ...
          EditTextField(
            ...
            validator: (v) {
              if (v == null || v.isEmpty) return "Sequence is required";
            ...
            child: Obx(
              () => ElevatedButton(
                ...
                child: controller.isSaving.value
                    ...
                    : Text(
                        controller.isEdit ? "Update Prefix" : "Save Prefix",
                        style: TextHelper.bodyMediumStyle(context).copyWith(
                          color: Colors.white,
